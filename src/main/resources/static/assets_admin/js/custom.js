...
$(document).ready(function() {
  ...
  // datatable de Gestion Profils
 /* var tableProfils = $('#tableProfils').DataTable({
    searching: false,
    language: {
    ...
    dom:
    "<'row'<'col-sm-3'l><'col-sm-7'><'col-sm-2'B>>" +
    "<'row'<'col-sm-12'tr>>" +
    "<'row'<'col-sm-5'i><'col-sm-7'p>>",
    buttons: [
      {
        text: '<i class="fas fa-plus"></i> Nouveau profil',
        className: "button-add-datatable",
