                            ...
                            <div class="pl-2 pr-2 col-md-8 text-center mb-2"style=" max-width: 521px; margin: auto;">
                                ...
                                <c:if test="${user.email==null}">
                                    <div class="border rounded p-2">
                                            <%--<i class="hp-box-icon fas fa-user pt-2" style="font-size: 5vw !important;"></i>--%>
                                        <img src="/assets/images/cadnat.png" style=" width: 85px;">
                                        <h3><spring:message code="label.Creernouveauxmotdepasse"/> </h3>
                                        <div>
                                                    ...
                                                    <c:when test="${pageContext.response.locale=='ar'}">
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group-append">
                                                                <button class="  text-center btn text-white" style="background-color: #336c4e !important">
                                            ...
                                            <div  style="margin-top: 5%;">
                                                <button type="button" onclick="updatePassword()" id=""  class="btn btn-success mb-2"> <i class="fa fa-unlock" ></i> <spring:message code="label.changerlemotdepasse"/></button>
                                            </div>
                                        </div>
                                    </div>
        ...
        $.ajax({
            ...
            success : function(response) {
                if(response=="OK")
                {
                    // swal({
                    //         title: "Modification ! ",
                    //         text: "le mot passe  a été modifier avec succès",
                    //         type: "success",
                    //     },
                    // );
