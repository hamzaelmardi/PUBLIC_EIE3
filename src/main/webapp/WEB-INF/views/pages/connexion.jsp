    ...
    <div class="col-md-8">
        <div class="row pr-2 justify-content-center">
            <div class="pl-2 pr-2 col-md-6 text-center mb-2">
                ...
                <c:if test="${user.email==null}">
                    <div class="border rounded p-2" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
                            <%--<i class="hp-box-icon fas fa-user pt-2" style="font-size: 5vw !important;"></i>--%>
                        <img src="/assets/images/cadnat.png" style=" width: 85px;">
                        <h3><spring:message code="label.espacedemandeur"/></h3>
                        <form id="formconexion" name="formconexion" action="/login" method="get">
                            <div style="margin-top: 5%;">
                                <input type="hidden" id="langage" name="langage" value="${pageContext.response.locale}">
                                <c:choose>
                                    <c:when test="${pageContext.response.locale=='ar'}">
                                        <div class="input-group mb-3">
                                            <div class="input-group-append position_icon_fr">
                                                <span class="input-group-text"><i class="fa fa-fw fa-user"></i></span>
                                            </div>
                                            <input name="j_name" id="j_name" dir='rtl' onchange="deleteVal()"
                                                   style="width: 80%" class="form-control inputlog"
                                                <%--onfocus="affiche_captcha('captcha_test','j_name','j_pass')"--%>
                                                   type="text" required
                                                   placeholder="<spring:message code="label.iden"/>">
                                        </div>

                                        <small class="form-text text-danger logs hidden"><spring:message code="label.identifiantestincorrect"/></small><br>
                                        <div class="input-group mb-3">
                                            <div class="input-group-append position_icon_fr">
                                        ...
                                        <small class="form-text text-danger pass hidden"><spring:message code="label.motdepasseestincorrect"/></small><br>
                                        <div id="captcha_test" dir="rtl" class="capbox">
                                    ...
                                    <c:otherwise>
                                        ...
                                        <small class="form-text text-danger pass hidden"><spring:message code="label.motdepasseestincorrect"/></small><br>
                                        <div id="captcha_test" dir="ltr" class="capbox">
                            ...
                            <div style="margin-top: 5%;">
                                ...
                                <a id="" onclick="loginMe()" class="btn btn-success mb-2"><i
...
<input type="hidden" value="${pageContext.response.locale}" id="lngs">
...
<script>
    ...
    function loginMe(){
      ...
      if($("form[name='formconexion']").valid()){
        $.ajax({
            type: "GET",
            url :"/loginme",
