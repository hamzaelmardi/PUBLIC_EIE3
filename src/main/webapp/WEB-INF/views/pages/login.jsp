                        ...
                        <div class="col-md-8 col-sm-12 pl-2 pr-2 mb-2" id="zone_rech">
                            <div class="  " style="height: 100%">
                                ...
                                <div class="row m-0 p-0 text-center mt-5 mb-5" id="sectmain">
                                    <div class="col-lg-6 col-md-6 col-sm-12 d-block block_vert hvr-float-shadow" onclick="sectautoris_table_select(1)">
                                        <div class="div_shadow rounded" style="border-top-right-radius: 3px !important; border-bottom-left-radius: 3px !important; ">
...
margin-bottom: 10px;">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 d-block block_vert hvr-float-shadow" onclick="sectautoris_table_select(2)">
                                        <div class="div_shadow rounded" style="border-bottom-right-radius: 3px !important;border-top-left-radius: 3px !important; ">
...
margin-bottom: 10px;">
                    ...
                    <!--  debut  -->
                    <div class="row justify-content-center div_1_1">
                            ...
                            <div class="row p-0 m-0">
                                <div class="col-12 pl-2 pr-2 mb-2" id="procedure_content">
                                    <div class="row-fluid d-none border p-2 bg-white" id="dev_step">
                                        ...
                                        <div class="col-2 p-0">
                                            <button class="btn btn-success btn-block" onclick="sectautoris_table_select(1)"><span
...
<%--                                                            </div>--%>
                            ...
                            <div class="row pr-2">
                                <div class="pl-2 pr-2 col-md-6 text-center mb-2">
                                        ...
                                        <div class="border rounded p-2">
                                            ...
                                            <form action="/login" method="get">
                                                ...
                                                <div style="margin-top: 5%;">
                                                    ...
                                                    <a href="/logout" class="btn btn-success"> <i style="margin-right: 5px;"
                                    ...
                                    <c:if test="${user.email==null}">
                                        <div class="border rounded p-2">
                                            ...
                                            <form id="formlogin" name="formlogin" action="/login" method="get">
                                                <div style="margin-top: 5%;">
                                                    <input type="hidden" id="langage" name="langage" value="${pageContext.response.locale}">
                                                    <c:choose>
                                                        <c:when test="${pageContext.response.locale=='ar'}">
                                                            <div class="input-group mb-3 pl-3 pr-3">
                                                                ...
                                                                <input name="j_name" id="j_name" dir='rtl' onchange="deleteVal()"
                                                                       onfocus="affiche_captcha('captcha_test','j_name','j_pass')"
                                                                       class="form-control inputlog"
                                                                       type="text" required style="width: 80%"
                                                                       placeholder="<spring:message code="label.iden"/>">

                                                            </div>

                                                            <small class="form-text text-danger logs hidden"><spring:message code="label.identifiantestincorrect"/></small>
                                                            <br/>
                                                            <div class="input-group mb-3 pl-3 pr-3">
                                                                <div class="input-group-append position_icon_ar">
                                                                    <span  onclick="showpassword(this)" class="input-group-text" ><i class="fa fa-fw fa-eye"></i></span>
                                                                </div>
                                                                <input name="j_pass" id="j_pass" dir='rtl'
                                                                       style="width: 80%"
                                                            ...
                                                            <small class="form-text text-danger pass hidden"><spring:message code="label.motdepasseestincorrect"/></small>
                                                            <br/><div id="captcha_test" dir="rtl" class="capbox collapse">
                                                            ...
                                                            <a href="/forget" dir='rtl' style="color:#1d1761 ;font-size: 13px;"><spring:message code="label.avezvousoublivotremotdepasse"/></a>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input name="j_name" id="j_name" onchange="deleteVal()" style="width: 80%"
                                                                       onfocus="affiche_captcha('captcha_test','j_name','j_pass')"
                                                                       class="form-control inputlog" type="text" required
                                                                       placeholder="<spring:message code="label.iden"/>">
                                                            </div>

                                                            <br/><small class="form-text text-danger logs hidden"><spring:message code="label.identifiantestincorrect"/></small>
                                                            <div class="input-group mb-3">
                                                                <div class="input-group-append position_icon_ar">
                                                                    <span  onclick="showpassword(this)" class="input-group-text" ><i class="fa fa-fw fa-eye"></i></span>
                                                                </div>

                                                                <input required dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}"
                                                                       type="password" value="" required style="width: 80%"
                                                                       placeholder="<spring:message code="label.Password"/>"
                                                                       class="form-control inputlog" name="j_pass" id="j_pass">

                                                                <%--<input name="j_pass" id="j_pass"
                                                            ...
                                                            <small class="form-text text-danger pass hidden"><spring:message code="label.motdepasseestincorrect"/></small>
                                                            <br/><div id="captcha_test" dir="ltr" class="capbox collapse">
                                                            ...
                                                            <a href="/forget" dir='ltr' style="color:#1d1761 ;font-size: 13px; "><spring:message code="label.avezvousoublivotremotdepasse"/></a>
                                                        </c:otherwise>
                                                    </c:choose>
                                                ...
                                                <div style="margin-top: 5%;">
                                                    ...
                                                    <a onclick="loginMe()" class="btn btn-success mb-2"><i
                                                            class="fa fa-unlock"></i> <spring:message
                                                            code="button.Seconnecter"/></a>
                                                    <a href="/demandez_compte" class="btt mb-2"> <i style="margin-right: 5px;"
                                                                                                    class="fa fa-user-plus ml-2"></i><spring:message
                                ...
                                <div class="pl-2 pr-2 col-md-6 text-center mb-2">
                                    <div class="border rounded p-2 h-100">
                                        <img class="" src="/assets/images/dossier.png" style=" width: 85px;"></i>
                                            ...
                                            <div class=" row m-0 p-0">
                                                <div class="col-12">
                                                    <input dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}" type="text"
                                                           ...
                                                           class="form-control etatmain inputlog"
                                                           name="num_notification" id="num_notifications">
                                                    <label id="cap1" style=" color: red;"></label>
                                                    <span id="notifSt"></span><br>
                                                    <div dir="ltr" class="capbox p-2">

                                                        <div id="CaptchaDivv" name="CaptchaDivv"></div>

                                                        <div class="capbox-inner p-2" style="${pageContext.response.locale=='ar'?'text-align:right;':'text-align:left;'}">
                                                            <spring:message code="label.Tapezlenumero"/><br>


                                                            <%--<input type="hidden" name="societesId" value="10">--%>

                                                            <input type="hidden" id="txtCaptchaa">
                                                            <input type="text" name="captcha" id="Captchay1" size="15" class="p-1 inputlog" required><br>

                                                        </div>
                                                    </div><br><br>
                                                    <label id="cap" style=" color: red;"></label>
                                                    <button class="btn btn-success etatmain mt-2" onclick="checknotifStatut()">
                                                    ...
                                                    <div style="width: 90%;margin-left: 5%;display: none" id="retsecmainetat">
                                                        ...
                                                        <button onclick="retsecmainetat()"
                                                                style="background-color: #336c4e;color: white" class="btn">
                    ...
                    <div class="row div_4">
                        ...
                        <div id="ressources" class="col-md-8 col-sm-12 pl-12 pr-12 mr-3 mt-4 " style="text-align:center">
                                        ...
                                        <div class="card-block-small">
                                            <a href="/faq">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <img src="${pageContext.request.contextPath}/assets/images/question_.png" />
                                                    </c:otherwise>
                                                </c:choose>
                                            </a>
...
<script>
    ...
    function checknotifStatut() {
        ...
        if (numnotif == "") {
            $("#cap1").text("<spring:message code="label.Silvousplaitsaisirlenumerovalide"/>");
            return false;
        }else{
            $("#cap1").text("");
        }
    ...
    function deleteVal(){
       ...
       // affiche_captcha('captcha_test','j_name','j_pass')
    }
    function loginMe(){
        var j_name=$("#j_name").val();
        var j_pass=$("#j_pass").val();
        $(".logs").addClass("hidden")
       if($("form[name='formlogin']").valid()){
           $.ajax({
               type: "GET",
    ...
    function loginSubmit(j_name,j_pass){
        ...
        if($("form[name='formlogin']").valid()){
            $.ajax({
                ...
                success : function(response) {
                    if(response === "user_out") {
                        $(".pass").removeClass("hidden");
                    }
                    else{
                        $(".pass").addClass("hidden");
                        window.location.href=response+"?lang="+langage;
                    }
                },
                error : function(response) {
    ...
    $(function() {
        ...
        $("form[name='formlogin']").validate({
            ...
            messages: {
                j_name: "<spring:message code="label.Silvousplaitsaisivotreidentifiantvalide"/>",
                j_pass: "<spring:message code="label.Silvousplaitsaisivotremotdepasse"/>",
