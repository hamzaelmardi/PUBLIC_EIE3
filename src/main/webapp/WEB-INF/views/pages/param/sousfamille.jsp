...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                                    ...
                                    <div class="progress">
                                      <div class="progress-bar" role="progressbar" style="width: 29%;" aria-valuenow="29" aria-valuemin="0" aria-valuemax="100">
                                          ...
                                          <div class="col-10 mt-4">
                                            <h3 style="float:right;color:black">Sous-Famille</h3>
      ...
      <select id="idfamille" class="form-control select2">
        <option selected>Choisissez une famille...</option>
        <c:forEach items="${listF1}" var="f1">
        	<option value="${f1.familleId}">${f1.nom}</option>
        </c:forEach>
                                              ...
                                              <label>Photo</label>
                                               ...
                                               <input type="file" name="" id="fileToUpload" class="form-control ">
                          ...
                          <div class="col-9 m-0 p-0">
                                              ...
                                              <div class="col-6">
                                                ...
                                                <label id="codeLabel" style="display:none">Entrez un nouveau Code</label>
                                              ...
                                              <div class="col-6">
                                                <div class="form-group">
                                                  ...
                                                  <input  onkeypress='validate(event)' type="text" id="reduction" class="form-control">
                                                </div>
                                              </div>
                                              <div class="col-6">
                                                <div class="form-group">
                                                  <label>Prix Min</label>
                                                  <input onkeypress='validate(event)' type="text" id="prixMin" class="form-control">
                                               </div>
                                              ...
                                              <div class="col-6">
                                                <div class="form-group">
                                                  ...
                                                  <input onkeypress='validate(event)' type="text" id="commission" class="form-control">
                                                </div>
                                              </div>
                                              <div class="col-6">
                                                <div class="form-group">
                                                  <label>Marge</label>
                                                  <input onkeypress='validate(event)' type="text" id="marge" class="form-control">
                                                </div>
                                              </div>
                                            ...
                                            <div class="row  mb-4" style="margin:14px;">
                                           	...
                                           	<button disabled="disabled" class="btn btn-primary btn-block btnTo" onclick="addFamille()" > Enregistrer</button>
                                 ...
                                 <table id="tableProfils" class="table table-striped hover compact table-bordered text-md-nowrap">
                                     <thead class="thead-bleu">
                                       <tr>
                                         ...
                                         <th class="text-center">R�duction</th>
                                    ...
                                    <tr id="tr-${f.familleId}">
                                         <td class="font-weight-semibold"><img  src="${pageContext.request.contextPath}${f.photo}"></td>
                                          <td>${f.famille.nom}</td>
                                         <td>${f.code}</td>
                                         <td>${f.nom}</td>
                                         <td>${f.marge}</td>
                                         ...
                                         <td class="text-center">
                                           <ul class="list-inline m-0">
                                             <li class="list-inline-item">
                                               <button onclick="delete_famille(${f.sousFamilleId})" class="btn btn-warning btn-sm rounded-circle tab_edit" type="button" data-toggle="tooltip" data-placement="top" title="Editer">
                                             ...
                                             <li class="list-inline-item">
                                               <button onclick="delete_tr(this)" class="btn btn-danger btn-sm rounded-circle tab_trash" type="button" data-toggle="tooltip" data-placement="top" title="Supprimer">
...
function addFamille(){
	...
	data.append('sousfamille', JSON.stringify(inputData));
