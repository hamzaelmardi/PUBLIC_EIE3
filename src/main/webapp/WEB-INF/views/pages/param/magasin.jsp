                                    ...
                                    <div class="progress">
                                      <div class="progress-bar" role="progressbar" style="width: 29%;" aria-valuenow="29" aria-valuemin="0" aria-valuemax="100">
                                          ...
                                          <div class="col-10 mt-4">
                                            <h3 style="float:right;color:black">Magasin</h3>
                                            <div class="row p-0 m-0 mt-5">
                                              ...
                                              <div class="col-6">
	                                                <div class="form-group">
	                                                   <label>Type</label>
	                                                  <select class="form-control" id="typeMagasin">
	                                                   <c:forEach items="${typeMagasin}" var="dd">
	                                                   <option ${ep.typeMagasin.typeMagasinId==dd.typeMagasinId ? "selected":"" } value="${dd.typeMagasinId }">${dd.nom }</option>
	                                                   </c:forEach>
	                                                 </select>
	                                                </div>
	                                              </div>
                                            ...
                                            <div class="row  mb-4" style="margin:14px;">
                                              <button  class="btn btn-primary btn-block btnTo" onclick="addMagasin()" > Enregistrer</button>
                                    ...
                                    <c:forEach items="${listF}" var="f">
                                         ...
                                         <td class="text-center">
                                           <ul class="list-inline m-0">
                                             ...
                                             <li class="list-inline-item">
                                               <button onclick="delete_famille(${f.magasinId})" class="btn btn-danger btn-sm rounded-circle tab_trash" type="button" data-toggle="tooltip" data-placement="top" title="Supprimer">
...
function addMagasin(){
	...
	var fournisseur={
			...
			"nom":nom,
			"typeMagasin":{"typeMagasinId":typeMagasin},
	}
