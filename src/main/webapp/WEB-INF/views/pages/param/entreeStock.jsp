                                    ...
                                    <div class="progress">
                                      <div class="progress-bar" role="progressbar" style="width: 29%;" aria-valuenow="29" aria-valuemin="0" aria-valuemax="100">
                                          ...
                                          <div class="col-10 mt-4">
                                            <h3 style="float:right;color:black">Article</h3>
                                            <div class="row p-0 m-0 mt-5">
                                              ...
                                              <div class="col-6">
                                                <div class="form-group">
                                                  ...
                                                  <input   type="text" id="designation" class="form-control"  value="${ep.designation}" >
                                                <label id="codeLabel" style="display:none">Entrez un nouveau Article</label>
                                              ...
                                              <div class="col-6">
                                                <div class="form-group">
                                                  ...
                                                  <input  required type="text" id="reference" class="form-control" value="${ep.reference}">
                                                  <label id="codeLabel2" style="display:none">Reference Existante</label>
                                               </div>
                                              ...
                                              <div class="row">
	                                              <div class="col-6">
	                                                <div class="form-group">
	                                                  <label>Prix</label>
	                                                  <input  required type="text" id="prix" class="form-control" value="${ep.prix}">
	                                               </div>
	                                              </div>       
                                              </div>
	                                              ...
	                                              <div class="col-6">
	                                                <div class="form-group">
	                                                  ...
	                                                  <select class="form-control" id="famille">
	                                                   <c:forEach items="${famille}" var="dd">
	                                                   <option ${ep.famille.familleId==dd.familleId ? "selected":"" } value="${dd.familleId }">${dd.nom }</option>
	                                                   </c:forEach>
	                                                 </select>
	                                                </div>
	                                              </div>
	                                                ...
	                                                <div class="form-group">
	                                                  ...
	                                                  <select class="form-control" id="fournisseur">
	                                                   <c:forEach items="${fournisseur}" var="db">
	                                                   <option ${ep.fournisseur.fournisseurId==db.fournisseurId ? "selected":"" }  value="${db.fournisseurId }">${db.nom }</option>
	                                                   </c:forEach>
	                                                 </select>
                      ...
                      <div class="col-12 grid-margin stretch-card z_tab" id="subtab_0"  >
                        <div class="card">
                                         ...
                                         <td class="text-center">
                                           <ul class="list-inline m-0">
                                             <li class="list-inline-item">
                                                  ...
                                                  <button onclick="frm_tables('subtab_0','frm_etatDoss',${f.articleId})" class="btn btn-warning btn-sm rounded-circle tab_edit" type="button" data-toggle="tooltip" data-placement="top" title="Editer">
                                             ...
                                             <li class="list-inline-item">
                                               <button onclick="delete_Article(${f.articleId})" class="btn btn-danger btn-sm rounded-circle tab_trash" type="button" data-toggle="tooltip" data-placement="top" title="Supprimer">
                         ...
                         <div class="text-center" dir="rtl">
							    ...
							    <button   onclick="list(0,6)"   class="btnss" >First</button>
							    <button   onclick="list(${page_db},6)" class="btnss" >precedent</button>
								...
								<c:forEach begin="${page}" end="${page+toAdd}" var="c">
									<button   onclick="list(${c},6)"  ${c==number ? 'class=" btnss active"' : 'class="btnss"'}>${c+1}</button>
								</c:forEach> 
								...
								<button   onclick="list(${page_end},6)"  class="btnss"   >suivant</button>
							   <button   onclick="list(${page_LAST},6)" class="btnss" >Last</button>
						</div>
...
function list(page, size) {
	getFunctionParam("/api/getParamArticle/"+page+"/"+size);
}
