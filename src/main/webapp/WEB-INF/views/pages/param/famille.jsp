              ...
              <!-- debut from etat dossier -->
                      <div class="col-12 from_add" id="frm_etatDoss" style="display: none; margin-top: 43px;">
                                    ...
                                    <div class="progress">
                                      <div class="progress-bar" role="progressbar" style="width: 29%;" aria-valuenow="29" aria-valuemin="0" aria-valuemax="100">
                                          ...
                                          <div class="col-10 mt-4">
                                            <h3 style="float:right;color:black">Famille</h3>
                          ...
                          <div class="col-9 m-0 p-0">
                            ...
                            <!-- <input type="text" name="" placeholder="Choisir un fichier" class="form-control ipt" readonly="readonly" onclick="trigger_upload()">
                            <input type="file" name="" onchange="file_upload(this)" id="fileToUpload" class="form-control d-none">
                          < --></div>
                          <div class="col-3 m-0 p-0">
                            <button class="btn btn-secondary btn-block font-weight-normal"  onclick="trigger_upload()" style="border-radius: 0 0.25rem 0.25rem 0">Parcourir</button> 
                          </div>
                        </div>
                                              </div>
                                              ...
                                              <div class="col-6">
                                                <div class="form-group">
                                                  <label>Nom</label>
                                                  <input  required type="text" id="nom" class="form-control">
                                               </div>
                             ...
                             <div class="col-11 pt-4">
                                 <table id="tableProfils" class="table table-striped hover compact table-bordered text-md-nowrap">
                                    ...
                                    <tr id="tr-${f.familleId}">
                                         <td class="font-weight-semibold"><img  src="${pageContext.request.contextPath}${f.photo}"><a target="_blank" download href="${fn:replace(f.photo, "/assets/myFile/", "/dowload_uploaded/")}  " class="btn btn-primary white" id="fileAdaaA">show</a>
                               </td>
                                         <td>${f.code}</td>
                                         <td>${f.nom}</td>
                                         ...
                                         <td class="text-center">
                                           <ul class="list-inline m-0">
                                             ...
                                             <li class="list-inline-item">
                                               <button onclick="delete_famille(${f.familleId})" class="btn btn-danger btn-sm rounded-circle tab_trash" type="button" data-toggle="tooltip" data-placement="top" title="Supprimer">
