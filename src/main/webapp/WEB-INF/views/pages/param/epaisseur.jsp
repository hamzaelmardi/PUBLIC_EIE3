                                    ...
                                    <div class="progress">
                                      <div class="progress-bar" role="progressbar" style="width: 29%;" aria-valuenow="29" aria-valuemin="0" aria-valuemax="100">
                                          ...
                                          <div class="col-10 mt-4">
                                            <h3 style="float:right;Epaisseur:black">Epaisseur</h3>
                                              ...
                                              <div class="col-6">
                                                <div class="form-group">
                                                  ...
                                                  <input value="${ep.nom}" required type="text" id="nom" class="form-control">
                              					   <label id="codeLabel2" style="display:none">Epaisseur existant</label>
                              					   
                              					     <input value="${ep.epaisseurId}"  type="hidden" id="id" class="form-control">
                                               </div>
                                            ...
                                            <div class="row  mb-4" style="margin:14px;">
                                              <button id="codeLabel" class="btn btn-primary btn-block btnTo" onclick="addEpaisseur()" > Enregistrer</button>
                                         ...
                                         <td class="text-center">
                                           <ul class="list-inline m-0">
                                             <li class="list-inline-item">
                                               <button onclick="frm_tables('subtab_0','frm_etatDoss',${f.epaisseurId})" class="btn btn-warning btn-sm rounded-circle tab_edit" type="button" data-toggle="tooltip" data-placement="top" title="Editer">
                                             ...
                                             <li class="list-inline-item">
                                               <button onclick="delete_epaisseur(${f.epaisseurId})" class="btn btn-danger btn-sm rounded-circle tab_trash" type="button" data-toggle="tooltip" data-placement="top" title="Supprimer">
