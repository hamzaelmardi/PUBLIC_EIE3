                                    ...
                                    <div class="progress">
                                      <div class="progress-bar" role="progressbar" style="width: 29%;" aria-valuenow="29" aria-valuemin="0" aria-valuemax="100">
                                          ...
                                          <div class="col-10 mt-4">
                                            <h3 style="float:right;Traitement:black">Type Magasin</h3>
                                            <div class="row p-0 m-0 mt-5">
                                              ...
                                              <div class="col-6">
                                                <div class="form-group">
                                                  <label>Type Magasin</label>
                                                  <input value="${ep.nom}" required type="text" id="nom" class="form-control">
                              					   <label id="codeLabel2" style="display:none">Type de magasin existant</label>
                              					   
                              					     <input value="${ep.agasinId}"  type="hidden" id="id" class="form-control">
                                               </div> 
                                            ...
                                            <div class="row  mb-4" style="margin:14px;">
                                              <button id="codeLabel" class="btn btn-primary btn-block btnTo" onclick="addTypeMagasin()" > Enregistrer</button>
                                 ...
                                 <table id="tableProfils" class="table table-striped hover compact table-bordered text-md-nowrap">
                                     <thead class="thead-bleu">
                                       <tr>
                                         ...
                                         <th class="text-center">Type de Magasin</th>
                                         ...
                                         <td class="text-center">
                                           <ul class="list-inline m-0">
                                             <li class="list-inline-item">
                                               <button onclick="frm_tables('subtab_0','frm_etatDoss',${f.typeMagasinId})" class="btn btn-warning btn-sm rounded-circle tab_edit" type="button" data-toggle="tooltip" data-placement="top" title="Editer">
                                             ...
                                             <li class="list-inline-item">
                                               <button onclick="delete_typeMagasin(${f.typeMagasinId})" class="btn btn-danger btn-sm rounded-circle tab_trash" type="button" data-toggle="tooltip" data-placement="top" title="Supprimer">
...
function addTypeMagasin(){
	...
	function delete_typeMagasin(id){
