                ...
                <div class="content-wrapper">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="pl-2 pr-2 col-md-8 text-center mb-2"style="margin: auto;height: 550px">
                                ...
                                <c:if test="${user.email==null}">
                                    <div class="border rounded p-2">
                                        <%--<i class="hp-box-icon fas fa-user pt-2" style="font-size: 5vw !important;"></i>--%>
                                        <img src="/assets/images/cadnat.png" style=" width: 85px;">
                                        <h3><spring:message code="label.reinitialiservotremotdepasse"/></h3>
                                            <hr>
                                            <div>
                                            <h6><spring:message code="label.Commentvoulezvousrecevoirvotrecodedereinitialisationdumotdepasse"/></h6>
                                            <div class="row justify-content-start ml-5">
                                                <input type="radio" id="radio1" name="drone" value="huey"
                                                       checked>
                                                <label><spring:message code="label.Envoyerlecodeparemail"/></label>&nbsp;
                                                ${mail}

                                            </div>
<%--                                            <div class="row justify-content-start ml-5">--%>
<%--                                                <input type="radio" id="radio2" name="drone" value="dewey">--%>
<%--                                                <label>Autre method</label>--%>
<%--                                            </div>--%>
<%--                                            <div class="row justify-content-start ml-5">--%>
...
<%--                                            </div>--%>
                                            ...
                                            <div  style="margin-top: 5%;">
                                                ...
                                                <button type="button" onclick="checkmail1('${id}')" id=""  class="btn btn-success mb-2"> <i class="fa fa-unlock" ></i><spring:message code="label.reinitialiservotremotdepasse"/> </button>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    function checkmail1(id){
        ...
        if(radio1) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    swal({
                        ...
                        text: "<spring:message code="label.pourlareinitialisationdevotremotdepasseunemailaeteenvoye"/> ",
                        type: "success",
           ...
           window.location.href="/autremethod/"+ id;
        }
    }
</script>
