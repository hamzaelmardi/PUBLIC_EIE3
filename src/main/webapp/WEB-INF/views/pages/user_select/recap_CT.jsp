...
<div class="row-fluid mt-5" style="margin-top: 206px !important;">
  <div class="col-12">
    <c:choose>
      <c:when test="${type=='IT'}">
...
<div class="container-fluid">
  <div class="row justify-content-center mt-5">
    <div class="col-md-10">
      <div class="tab myTabb" role="tabpanel">
        <!-- Nav tabs -->
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a onclick="Recap(${collect.id_collecte})" aria-controls="home" role="tab" data-toggle="tab">${collect.num_demande}</a></li>
          <c:forEach items="${listCollecte}" var="x" varStatus="loopp">
            <li role="presentation"><a type="button" onclick="Recap(${x.id_collecte})" aria-controls="sec${x.id_collecte}" role="tab" data-toggle="tab">${x.num_demande}</a></li>
          </c:forEach>
        </ul>
        <!-- Tab panes -->
        <div class="myTab">
                                ...
                                <div class="row mb-2">
                                  ...
                                  <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                      ...
                                      <input type="tel" disabled value="${collect.demandeurTel}" class="form-control">
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="card-header panel-heading" id="headingSix">
                                      <h5 class="mb-0 panel-title">
                                        <a class="accordion-toggle btn collapsed ${pageContext.response.locale=="ar"?'text-right':'text-left'} " type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                          <i class="icon fa fa-file-download ${pageContext.response.locale=="ar"?'ml-3':'mr-3'}"></i><spring:message code="label.Listedanciennecollectesdesdechets"/>
                                        </a>
                                      </h5>
                                  </div>
                                          ...
                                          <table class="table my_table table-striped text-center table-bordered table-hover">
                                              <thead>
                                                <tr>
                                                  ...
                                                  <th class=""><spring:message code="label.Datededemandedavenant"/> </th>
                                                </tr>
                                              </thead>
                                              <tbody>
...
<script type="text/javascript">
  function Recap(id){
    $.ajax({
      ...
      type: "GET",
      url : "/api/CollecteRecap/"+id,
      data: {},
      success : function(response) {
        $("#Section0").html(response);
      },
      error : function() {
