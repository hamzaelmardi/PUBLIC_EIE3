                            ...
                            <div class="pl-2 pr-2 col-md-8 text-center mb-2"style=" max-width: 521px; margin: auto;">
                                ...
                                <c:if test="${user.email==null}">
                                    <div class="border rounded p-2">
                                        <%--<i class="hp-box-icon fas fa-user pt-2" style="font-size: 5vw !important;"></i>--%>
                                        <img src="/assets/images/cadnat.png" style=" width: 85px;">
                                        <h3>Retrouvez votre compte</h3>
                                            <hr>
                                            <h6>veuillez entrer votre Numéro d'autorisation et chosissez le statut</h6>





                                            <div  id="numeroAutorisation" >
                                                <div  style="margin-top: 5%;">
                                                    <c:choose>
                                                        <c:when test="${pageContext.response.locale=='ar'}">

                                                            <input id="numauto"  dir='rtl' style="width: 95%;margin-left: 3%;" class="form-control" type="text" placeholder="Numéro d'autorisation"><p id="in_email"></p>
                                                            <label id="chekmail1" style=" color: red;"></label>
                                                            <select id="idStatut" name="idStatut" style="width: 95%;margin-left: 3%;" class="form-control">
                                                        ...
                                                        <c:otherwise>
                                                            <input id="numauto" style="width: 95%;margin-left: 3%;" class="form-control" type="text" placeholder="Numéro d'autorisation"><p id="in_email"></p>
                                                            <label id="chekmail1" style=" color: red;"></label>
                                                            <select id="idStatut" name="idStatut"  style="width: 95%;margin-left: 3%;" class="form-control">
                                                                <option value="0">Choisir.........</option>
                                                                <c:forEach items="${status}" var="s">
                                                ...
                                                <div  style="margin-top: 5%;">
                                                    <button type="button" onclick="step2(${id})" id=""  class="btn btn-success mb-2"> <i class="fa fa-unlock" ></i> Continuer</button>
                                                </div>
                                            </div>
                                    </div>
...
<script>
    /*function step1(){
        ...
        $.get( baseUrl+"/checkIdentifiant/"+mail , function(rep) {
            if(rep == 0){
                $("#identi").val(mail);
                $("#chekmail").text("merci de saisir un email valide ");
            }
            else{
                $("#identifiant").hide();
                $("#numeroAutorisation").show();
    ...
    function step2(id){
        var mail = $("#numauto").val();
        var statut=$("#idStatut").val();
        ...
        $.get( baseUrl+"/check_auto/"+mail+"/"+statut+"/"+id , function(rep) {
            if(rep == 0){
                $("#numauto").val(mail);
                $("#chekmail1").text("merci de saisir numéro d'autorisation valide ");
            }
            else{
                window.location.href="/getforget/"+id;
            }
