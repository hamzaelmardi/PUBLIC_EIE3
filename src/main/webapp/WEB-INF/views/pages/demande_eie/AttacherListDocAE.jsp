    ...
    <section class="mt-2 bg-white container-fluid" dir="${pageContext.response.locale=='ar'?'rtl':'ltr'}">
        ...
        <div class="row" style="text-align: ${pageContext.response.locale=='ar'?'right':'left'}">
            <div class="col-md-3 col-sm-12">
                <c:choose>
                    <c:when test="${type=='AE'}">
                        <button style="text-align: ${pageContext.response.locale=='ar'?'right':'left'}" class="btn btn-success btn-block active pl-5 cls_step" id="step_id1" onclick="affiche_eie_zone('#step1','#step_id1')">1.<spring:message code="label.Attacherlesdocuments"/>  </button>
                    </c:when>
                </c:choose>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col mt-3  ">
                                                <div class="form-group">
                                                    <div>
                                                        <label style="width: 100%;"> ${pageContext.response.locale=='ar'?dc.nom_ar:dc.nom_fr } </label> <input
                                                            required
                                                    ...
                                                    <c:forEach items="${docNotify}" var="d">
                                                        <c:if test="${d.docImport.id_docImport==dc.id_docImport}">
                                                            <a href="/downloadFile/${fn:replace(d.url,"/assets/myFile/","")}"
                                                               class="btn btn-success rounded file_existe btn_down" type="button" ><span
