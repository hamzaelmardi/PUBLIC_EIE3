...
<div class="col-md-12 div2" style="margin-top: 13rem; ${pageContext.response.locale=='ar'?'text-align:right':'text-align:left'}" dir="${pageContext.response.locale=='ar'?'rtl':'trl'}">

    <div class="tab-content tab-content-vertical">
        <div class="tab-pane fade active show" id="home-2" role="tabpanel" aria-labelledby="home-tab-vertical">
            <div class="row zone_table ">
                <div class="col-2"></div>
                <div class="col-lg-8 col-md-12">
                    <form class="form-horizontal mt-3" action="" id="pieceForm">
                        ...
                        <div class="row m-0 p-0 mt-5">
                            ...
                            <div class="col-md-6 col-sm-12" style="text-align: center">
                                <button onclick="changer_statut_type('id_dmd','9','<spring:message code="label.Lesfichierssontenregistres"/> ','${type}')"
